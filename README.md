...
I explain here how to build your own site locally using this repository. First, clone the repository using the method of your choice. For example, using HTTPS:
...
This should open a serve address of the form http://0.0.0.0:4000 that you can open in any browser. If modifications are made to the code, refreshing the page is sufficient to see the corresponding changes on the site. 
